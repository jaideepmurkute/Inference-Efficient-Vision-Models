...
def load_checkpoint(cfg, load_type: str, model=None, optimizer=None, scheduler=None, fold_id=0, suffix: str = "best", is_teacher=False):
    valid_load_types = ["model", "optimizer", "scheduler", "training_log", "fold_idx_dict"]
