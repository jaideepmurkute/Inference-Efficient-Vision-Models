...
class QuantConfig:
    def __init__(self, **kwargs):
        ...
        self.experiment_name = "test"  # kaggle_quant_2
        ...
        # Paths to potential source models
        self.teacher_exp_path = os.path.join(
            "..", "teacher_training", "output", "kaggle_exp_2"
        )
        self.student_exp_path = os.path.join(
            "..", "knowledge_distillation", "output", "kaggle_kd_exp_2"
        )
